...
def test():
  ...
  scenario += nft
  nft.mint(token_id=0, address=jerry.address, amount=1, metadata = sp.map({"": sp.utils.bytes_of_string("ceramic://kjzl6cwe1jw146yat39rx1oobo2e6cv1xww12k1gg2trbbu210p0h52bpwniuma")})).run(sender=admin)